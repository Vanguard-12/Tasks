...
function ErrorState({ message }: { message: string }) {
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center">
      <p className="text-sm text-red-600">Не удалось загрузить историю запусков</p>
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center">
      ...
      <p className="text-sm text-muted-foreground">История запусков пуста</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute inset-0 flex flex-col">
      ...
      <div className="grid flex-shrink-0 grid-cols-[1fr_auto] items-center gap-3 border-b border-border p-4">
        <h2 className="text-lg font-semibold tracking-tight">История запусков</h2>
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <SelectContent align="end">
              ...
              <SelectSeparator />
              <SelectGroup>
                <SelectLabel>Активность</SelectLabel>
              ...
              <SelectSeparator />
              <SelectGroup>
                <SelectLabel>Внимание</SelectLabel>
